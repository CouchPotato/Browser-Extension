...
kango.addMessageListener('checkApi', function(event) {
	kango.console.log('checking api');
...
kango.addMessageListener('showiFrame', function(event){
	...
	// Styles
	addStyle('\
	    #cp_popup { font-family: "Helvetica Neue", Helvetica, Arial, Geneva, sans-serif; -moz-border-radius: 6px 0px 0px 6px; -webkit-border-radius: 6px 0px 0px 6px; border-radius: 6px 0px 0px 6px; -moz-box-shadow: 0 0 20px rgba(0,0,0,0.5); -webkit-box-shadow: 0 0 20px rgba(0,0,0,0.5); box-shadow: 0 0 20px rgba(0,0,0,0.5); position:fixed; z-index:9999; bottom:top; right:0; font-size:15px; margin: 20px 0; display: block; background:#4E5969; } \
